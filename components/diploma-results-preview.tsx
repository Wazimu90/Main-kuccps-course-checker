...
export default function DiplomaResultsPreview({ courses, onProceed }: DiplomaResultsPreviewProps) {
  ...
  // Load actual diploma results from Supabase
  useEffect(() => {
    const loadDiplomaResults = async () => {
      try {
        ...
        if (error || !resultData) {
          console.error("Error fetching diploma results from cache:", error)
          setIsLoading(false)
          return
        }
        ...
        console.error("Error loading diploma results:", error)
        setIsLoading(false)
      }
    }

    loadDiplomaResults()
  }, [qualifyingCoursesCount, countiesCount])
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-900 via-teal-900 to-emerald-900 p-4">
        <div className="max-w-4xl mx-auto bg-emerald-800/70 backdrop-blur-lg rounded-3xl shadow-2xl p-8 md:p-12 border border-emerald-700/50">
          <div className="text-center py-8 space-y-6">
            ...
            >
              We're preparing your personalized diploma course results...
            </motion.p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto bg-emerald-800/70 backdrop-blur-lg rounded-3xl shadow-2xl p-8 md:p-12 border border-emerald-700/50">
          <div className="text-center py-8 space-y-6">
            ...
            <motion.h3
              ...
              className="text-2xl font-bold text-emerald-100"
            >
              No Qualifying Diploma Courses Found
            </motion.h3>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              ...
              className="text-emerald-300 max-w-md mx-auto text-lg"
            >
              Based on your current grades and selected categories, you don't meet the requirements for diploma courses.
            ...
            >
              <Button
                ...
                className="border-emerald-600 text-emerald-300 hover:bg-emerald-700 px-8 py-3"
              >
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-900 via-teal-900 to-emerald-900 p-4">
      ...
      >
        ...
        <div className="text-center mb-12">
          ...
          >
            Based on your KCSE grades and selected diploma course categories
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          ...
          >
            ...
            <div className="text-emerald-100 text-lg font-medium">Diploma Course Level</div>
          </motion.div>
        </div>
