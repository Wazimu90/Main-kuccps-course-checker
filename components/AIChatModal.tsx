    ...
    const handleSendMessage = async () => {
        ...
        try {
            ...
            if (data.content) {
                ...
                console.error("AI response error:", JSON.stringify(data.error))
                setMessages([...newMessages, { role: 'model', content: `Sorry, I encountered an error: ${typeof data.error === 'string' ? data.error : 'Unknown error'}. Please try again.` }])
            }
                    ...
                    >
                        ...
                        <div className="bg-gradient-to-r from-purple-600 to-indigo-600 p-4 flex items-center justify-between shadow-lg z-10">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-white font-bold text-lg">Course AI Assistant</h3>
