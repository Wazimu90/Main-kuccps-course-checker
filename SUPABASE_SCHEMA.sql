...
create table public.degree_programmes (
  institution_name text null,
  programme_code text null,
  programme_name text null,
  cutoff_2023 double precision null,
  subject_1 text null,
  subject_2 text null,
  subject_3 text null,
  subject_4 text null,
  constraint degree_programmes_programme_code_key unique (programme_code)
) TABLESPACE pg_default;


-- Diploma Programmes Table
-- Stores all diploma programs
create table public.diploma_programmes (
  id bigint generated by default as identity not null,
  programme_name text not null default ''::text,
  programme_code text null,
  institution text null,
  county text null,
  institution_type text null,
  cluster_group text null,
  mean_grade text null,
  subject_1 text null,
  subject_2 text null,
  subject_3 text null,
  subject_4 text null,
  constraint diploma_programmes_pkey primary key (id)
) TABLESPACE pg_default;

-- Certificate Programmes Table
-- Stores all certificate programs
create table public.certificate_programmes (
  id bigint generated by default as identity not null,
  programme_name text null,
  institution text null,
  programme_code text null,
  ...
  subject_3 text null,
  subject_4 text null,
  constraint certificate_programmes_pkey primary key (id)
) TABLESPACE pg_default;

-- KMTC Programmes Table
-- Stores Kenya Medical Training College programs
create table public.kmtc_programmes (
  id bigint generated by default as identity not null,
  ...
  county text null,
  institution_type text null,
  constraint kmtc_programmes_pkey primary key (id),
  constraint kmtc_programmes_programme_code_key unique (programme_code)
) TABLESPACE pg_default;

-- Artisan Programmes Table
-- Stores artisan/vocational programs
create table public.artisan_programmes (
  id bigint generated by default as identity not null,
  programme_name text null,
  programme_code text null,
  institution_name text null,
  ...
  cluster_group text null,
  mean_grade text null,
  constraint artisan_programmes_pkey primary key (id)
) TABLESPACE pg_default;


-- Degree Cluster Programmes Table
-- Stores degree programmes clusters
create table public.degree_programme_clusters (
  programme_code text not null,
  programme_name text null,
  ...
  institution_type text null,
  county text null,
  constraint degree_programme_clusters_pkey primary key (programme_code),
  constraint unique_cluster_programme_code unique (programme_code)
) TABLESPACE pg_default;

-- Results Cache Table
-- Stores results cahe waiting for payment
create table public.results_cache (
  id uuid not null default gen_random_uuid (),
  phone_number text null,
  email text null,
  category text null,
  eligible_courses jsonb null,
  created_at timestamp without time zone null default timezone ('Africa/Nairobi'::text, now()),
  result_id text null,
  name text null,
  constraint results_cache_pkey primary key (id),
  constraint results_cache_result_id_key unique (result_id)
) TABLESPACE pg_default;
...
create table public.subject_codes (
  ...
  code numeric null,
  constraint subject codes_pkey primary key (id)
) TABLESPACE pg_default;
